<template>
  ...
  <div style="height:15px;" v-show="!showSearch"></div>
    <el-form :model="queryParams" ref="queryForm" class="formQuery"  v-show="showSearch" :inline="true">
    ...
    methods: {
      ...
      designModeler(id) {
        ...
        const routeUrl = this.$router.resolve({
          path: process.env.VUE_APP_BASE_API + "/modeler/modeler.html?modelId=" + id +"&token=" + getToken(),
        });
