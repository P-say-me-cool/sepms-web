...
<script>
import { listFarm, getFarm, delFarm, addFarm, updateFarm } from "@/api/model/farm";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除车间编号为"' + farmIds + '"的数据项?', "警告", {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('model/farm/export', {
        ...this.queryParams
      }, `model_farm.xlsx`)
    }
  }
