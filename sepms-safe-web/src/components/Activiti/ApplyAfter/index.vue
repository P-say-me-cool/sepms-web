    ...
    methods: {
      ...
      handleState: function () {
        ...
        this.$confirm('是否确认' + opt + 'ID为"' + instanceId + '"的流程实例?', "警告", {
          ...
          return request({
            url: '/activiti/activiti/process/suspendOrActiveApply',
            method: 'post',
            params: data
          });
        }).then(response => {
      ...
      handleCancel: function () {
        ...
        this.$confirm('是否确认撤销ID为"' + instanceId + '"的流程实例?', "警告", {
          ...
          return request({
            url: '/activiti/activiti/process/cancelApply',
            method: 'post',
            params: data
          });
        }).then(response => {
      ...
      handleViewProcessImg: function() {
        ...
        this.src = baseURL + '/activiti/activiti/process/read-resource?pProcessInstanceId=' + this.row.instanceId + '&_=' + new Date().getTime();
        this.srcList = [];
      ...
      getHistoryList: function () {
        this.loading = true;
        return request({
          url: '/activiti/activiti/process/listHistory',
          method: 'post',
      ...
      submitForm() {
        ...
        this.$confirm('是否确认转办给' + selectedRow.nickName + '?', "警告", {
          ...
          return request({
            url: '/activiti/activiti/process/delegate',
            method: 'post',
