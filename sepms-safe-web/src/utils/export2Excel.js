...
export default {
  setExport2Excel(tableId,fileName,colSize) {
    /* generate workbook object from table */
    var xlsxParam = {raw: true}   //这个保证表格只进行解析 不做运算
    var wb = XLSX2.utils.table_to_sheet(document.querySelector("#"+tableId), xlsxParam);//mytable为表格的id名
    ...
    this.openDownloadDialog(filedata,fileName+ ".xlsx")
  },
//为合并项添加边框
